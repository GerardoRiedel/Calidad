...
<body>
        ...
        <div class="container" id="login-block" >
    		<div class="row">
			    <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
			       ...
			       <div class="login-box clearfix animated flipInY"style="background-color: #f0f0e1">
                            ...
                            <a href="#"><img src="<?php echo base_url(); ?>../assets/img/calidad.png" alt="Company Logo" width="120" /></a>
                        </div>
                                   <div class="login-logo" style="padding-top: 20px">
                                       <span style="color:green">Ingreso Usuario Externo</span>
                                   </div>
			        	<hr/>
                                        <?php //IF(empty($recuperar)){ ?>
			        	<div class="login-form">
			        	 		<form action="<?php echo base_url().'login/usuario_externo'; ?>" method="post"  >
						   		 ...
						   		 <p style="line-height: 70px; text-align: center;"><button type="submit" class="btn btn-success">Volver</button> 
                                       ...
                                       <span style="color:green; font-size: 10px">Si no cuenta con clave o presenta problemas de acceso favor comunicarse con el departamento de Calidad al correo calidad@cetep.cl</span>
                                   </div>
			    </div>
         ...
         <div class="clearfix animated bounceinUp">
     		<p class="lead" id="footer-text"><small>Copyright &copy; Cetep 2018, Todos los derechos reservados.</small></p>
            </div>
     	</footer>
