                ...
                <table>
                           <tr>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 12px;width: 300px;background-color: <?php echo $color; ?>" align="justify"><?php 
                                ...
                                <td style="font-size: 12px;width: 200px;background-color: <?php echo $color; ?>" align="justify"><?php 
                                ...
                                <td style="font-size: 12px;width: 130px;background-color: <?php echo $color; ?>" align="justify"><?php IF($item->plaSeguimiento !=='0'){
